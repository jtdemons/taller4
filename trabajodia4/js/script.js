window.onload = function()
{
    ...
    */
    ...
    //console.log(datosDecimal.entero);
...
//console.log(datosDecimal.decimal);
    //Función que realizará la conversión...
    var decimalFraccionario = function()
    {
        var base =Math.pow(10,String(datosDecimal.decimal).length);
    var numera = (String(datosDecimal.entero)+ "." + String(datosDecimal.decimal));
    var denomi = numera * base;
    var  resulpuesta = simplificaFraccionario(denomi + "/" + base);
       ...
       // console.log(datosDecimal.entero);
        ...
        nom_div("resFraccionario").innerHTML = resulpuesta;
    };
